...
with smart_run(session):
    ...
    while(option!= "0"):
        ...
        print("4. Interact with image recognisition")
        print("5. Interact by Locations")
        print("6. Watch Stories")
        ...
        if(option=="1"):
            ...
            print("Interacting with your own feed")
            session.set_do_comment(True, percentage=10)
            session.set_comments(['What camera do you use?'])
            session.set_use_clarifai(enabled=True, api_key="f09b2ead71a840839f34fea463fe9873")
